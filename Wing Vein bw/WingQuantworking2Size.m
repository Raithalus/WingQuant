...
%% Load Images
WingFiles = dir('C:\Users\David Cheung\Desktop\Wings_for_david_20171108current\K\*.png');
...
bwthresh = graythresh(WingI);
bw = im2bw(WingI, bwthresh);
